...
def default_mock_behaviors():
    ...
    return [
        ...
        MockBehavior(
            "binary_sensor.example_office_window", iter(["off", "off", "off"])
        ),
        MockBehavior("sensor.kitchen_temperature", iter(["5", "6", "7", "8", "9"])),
        MockBehavior("sensor.kitchen_temperature_rate", iter(["0", "0", "0", "0", "0"])),
        MockBehavior(
            "binary_sensor.example_kitchen_window", iter(["off", "off", "off"])
        ),
        MockBehavior("sensor.example_outdoor_temperature", iter(["1", "1", "1"])),
