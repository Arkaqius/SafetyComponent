...
def _temperature_component_rooms():
    return {
        "Office": {
            ...
            "window_sensor": "binary_sensor.example_office_window",
        },
        "Kitchen": {
            "area_id": "kitchen",
            "CAL_LOW_TEMP_THRESHOLD": 18.0,
            ...
            "window_sensor": "binary_sensor.example_kitchen_window",
        },
    }
...
def _base_user_config():
    return {
        ...
        "common_entities": {"outside_temp": "sensor.example_outdoor_temperature"},
        "safety_components": {
