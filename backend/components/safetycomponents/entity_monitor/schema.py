...
def validate_entity_monitor_config(
    ...
    *,
    ...
    try:
        ...
        policy_input = dict(calibration or {})
        policy_input["component_overrides"] = {
            **dict(policy_input.get("component_overrides", {})),
            **validated.component_overrides,
        }
        policy = EntityMonitorCalibration.model_validate(
            policy_input, context={"strict_validation": strict_validation}
        )
        component_overrides = {
