...
export const MOCK_ENTITIES: EntityMap = {
  ...
  'binary_sensor.bathroom_gasleak_detector_gas': entity('off', 'Łazienka - czujnik gazu'),
  'binary_sensor.bathroom_carbonoxide_detector_carbon_monoxide': entity('off', 'Łazienka - czujnik tlenku węgla'),
