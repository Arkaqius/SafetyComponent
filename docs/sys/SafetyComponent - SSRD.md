...
| SWR-NOT-013 | An acknowledgement action shall suppress subsequent L1 repeats without clearing the active fault or preventing quiet content refreshes. It shall quietly replace the phone notification without the acknowledgement action so that the user receives visible feedback. | mobile action handler |
